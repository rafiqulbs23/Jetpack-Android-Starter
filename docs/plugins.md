...
### 1. Application Plugin (`com.aristopharma.v2.application`)
...
### 2. Library Plugin (`com.aristopharma.v2.library`)
...
### 3. UI Library Plugin (`com.aristopharma.v2.ui.library`)
...
### 4. Dagger Hilt Plugin (`com.aristopharma.v2.dagger.hilt`)
...
### 5. Firebase Plugin (`com.aristopharma.v2.firebase`)
