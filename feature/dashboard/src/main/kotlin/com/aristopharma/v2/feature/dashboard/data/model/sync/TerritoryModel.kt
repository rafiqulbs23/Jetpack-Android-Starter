...
/**
 * Territory model from first sync.
 * Contains territory assignment data.
 */
@Serializable
data class TerritoryModel(
    @SerialName("territoryId") val territoryId: Int? = null,
    @SerialName("territoryName") val territoryName: String? = null,
