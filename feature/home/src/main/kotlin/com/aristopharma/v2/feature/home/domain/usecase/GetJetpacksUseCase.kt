...
/**
 * Use case for retrieving all jetpacks.
 *
 * This use case encapsulates the business logic for fetching jetpacks
 * and ensures separation of concerns between the domain and data layers.
 */
class GetJetpacksUseCase @Inject constructor(
    private val repository: HomeRepository,
) {
    /**
     * Executes the use case to retrieve all jetpacks.
     *
