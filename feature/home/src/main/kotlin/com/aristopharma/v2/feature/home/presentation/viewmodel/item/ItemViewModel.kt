...
package com.aristopharma.v2.feature.home.presentation.viewmodel.item
...
class ItemViewModel @Inject constructor(
    ...
    private val _itemUiState = MutableStateFlow(UiState(ItemState()))
    val itemUiState = _itemUiState
        .onStart { getJetpack() }
        .stateInDelayed(UiState(ItemState()), viewModelScope)
    ...
    private fun getJetpack() {
        existingJetpackId?.let {
            getJetpackUseCase(existingJetpackId)
                ...
                .catch { e -> UiState(ItemState(), error = e.asOneTimeEvent()) }
