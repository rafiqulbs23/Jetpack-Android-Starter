...
group = "com.aristopharma.v2.build.logic"
...
gradlePlugin {
    plugins {
        register("library") {
            id = "com.aristopharma.v2.library"
            implementationClass = "LibraryConventionPlugin"
        }
        register("uiLibrary") {
            id = "com.aristopharma.v2.ui.library"
            implementationClass = "UiLibraryConventionPlugin"
        }
        register("application") {
            id = "com.aristopharma.v2.application"
            implementationClass = "ApplicationConventionPlugin"
        }
        register("daggerHilt") {
            id = "com.aristopharma.v2.dagger.hilt"
            implementationClass = "DaggerHiltConventionPlugin"
        }
        register("firebase") {
            id = "com.aristopharma.v2.firebase"
            implementationClass = "FirebaseConventionPlugin"
        }
        register("dokka") {
            id = "com.aristopharma.v2.dokka"
